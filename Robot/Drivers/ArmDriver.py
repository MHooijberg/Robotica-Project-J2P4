...
#                 self.servoLibrary.move(self.servoIds[3], 0)
    ...
    def StabilizeHead(self):
        ...
        print("\n==== Servo Information ====")
        print("Servo ",str(self.servoIds[1]),": Position ",str(pos2)," | Degrees ",str(deg2)," | Relative Degrees ",str(relativeDeg2))
        print("Servo ",str(self.servoIds[2]),": Position ",str(pos3)," | Degrees ",str(deg3)," | Relative Degrees ",str(relativeDeg3))
        print("Head Servo ",str(self.servoIds[3]),": Position ",str(currentHeadPos)," | Degrees ",str(degHead)," | Relative Degrees ",str(relativeHeadDeg)," | Needed Rotation ",str(neededRotation)," | Absolute End Rotation ",str(neededRotation + 150), " | Absolute End Position ", str(headPos))
